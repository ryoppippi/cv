...
#alta(
  ...
  - #styled-link("https://github.com/ryoppippi/sitemcp")[SiteMCP] (#icon("star")722): Fetch an entire site and use it as an MCP Server. This tool scrapes pages from a website, converts into markdown files, cache them, and serves them as a local MCP server. It is useful when you ask LLMs to ask questions about a libraries/documentation.
